...
const DonationPage = () => {
    ...
    // Check for successful payment on page load (handling redirect back from Stripe)
    useEffect(() => {
        ...
        if (success === 'true' && sessionId) {
            ...
            // You might want to verify the session on your server here

            // Refresh donation history if showing
            if (showHistory) {
