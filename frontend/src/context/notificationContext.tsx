...
export const NotificationProvider: React.FC<NotificationProviderProps> = ({
  ...
  const [showNewNotifications, setShowNewNotifications] =
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      ...
      try {
        const response =
          await customAxios.get<INotificationResponse>("/api/notifications");
  ...
  useEffect(() => {
    ...
    newSocket.on(
      "new-notification",
      (notification: Omit<INotification, "timestamp">) => {
