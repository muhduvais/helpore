...
export class VolunteerController implements IVolunteerController {
    ...
    async getVolunteers(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            if (volunteers) {
                res.status(HttpStatusCode.OK).json({ success: true, volunteers, totalPages, totalVolunteers: documentsCount });
            } else {
                res.status(HttpStatusCode.BAD_REQUEST).json({ success: false, message: ErrorMessages.USER_NOT_FOUND });
            }
        } catch (error) {
    ...
    async getVolunteerDetails(req: Request, res: Response): Promise<void> {
        try {
            ...
            if (volunteer) {
                res.status(HttpStatusCode.OK).json({ success: true, volunteer, address });
            } else {
    ...
    async changePassword(req: Request, res: Response): Promise<void> {
        ...
        try {
            ...
            if (changePassword) {
                res.status(HttpStatusCode.OK).json({ success: true, message: ErrorMessages.PASSWORD_UPDATE_SUCCESS });
            }
        } catch (error) {
