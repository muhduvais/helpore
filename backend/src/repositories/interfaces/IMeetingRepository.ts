...
export interface IMeetingRepository {
  ...
  findById(meetingId: string): Promise<IMeetingDocument | null>;
  findAll(query: any, skip: number, limit: number): Promise<IMeetingDocument[]>;
  ...
  findUpcomingMeetings(): Promise<IMeetingDocument[] | null>;
}